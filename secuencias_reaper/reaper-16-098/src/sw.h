...
#define STRINGIFY(v) STRINGIFY0(v)
                  ...
                  /* defining SWNUM as double has been the default, so well tested.
                   * 'unsigned' is almost two times faster.
                  */
#ifndef SWNUM
#     define SWNUM double
#endif
...
#define SW_NW_FILL        ( 1 <<  5 )
#define SW_NW_TRACE       ( 1 <<  6 )
#define SW_NW_CODE        ( 1 <<  7 )
